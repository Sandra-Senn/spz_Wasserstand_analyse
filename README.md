...
- Datenvorverarbeitung und Auswahl relevanter Zeitreihen (z. B. Wasserstand und meteorologische Variablen)
- Explorative Analyse (Visualisierung und Korrelationsprüfung)
- Aufbau und Vergleich verschiedener Prognosemodelle (z. B. lineare Regression, Zeitreihenmodelle, Machine Learning)
- Validierung und Evaluation der Vorhersagegüte
